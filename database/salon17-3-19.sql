...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 17, 2019 at 05:47 PM
...
CREATE TABLE IF NOT EXISTS `accounts` (
  ...
  `total_tasks` varchar(15) NOT NULL,
...
INSERT INTO `accounts` (`id`, `worker_id`, `total_tasks`, `salary_month`, `salary_amount`, `created_at`, `updated_at`) VALUES
(1, 11, '1', 'March 1, 2019 - March 31, 2019', '800.00', '2019-03-17 04:03:02', '2019-03-17 05:03:19');
...
CREATE TABLE IF NOT EXISTS `appoinments` (
  ...
  `appoinment_time` varchar(15) NOT NULL,
...
(4, 1, 8, '2019-03-21', '06:00 PM', 1, 'test', '2019-03-16 02:03:50', '2019-03-17 10:03:07');
...
INSERT INTO `assign_tasks` (`id`, `task_id`, `worker_id`, `appoinment_id`, `task_date`, `task_status`, `created_at`, `updated_at`) VALUES
(3, 1, 11, 1, '2019-03-19 00:00:00', 1, '2019-03-10 09:03:06', '2019-03-11 05:03:46'),
(7, 1, 1, 1, '2019-03-11 00:00:00', 1, '2019-03-10 10:03:10', '2019-03-10 10:03:18');
