      ...
      <div class="box">
        ...
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open(base_url('admin/tasks/add'), 'class="form-horizontal"');  ?> 
              <div class="form-group">
                <label for="task_name" class="col-sm-2 control-label">Task Name</label>

                <div class="col-sm-9">
                  <input type="text" name="task_name" class="form-control" id="task_name" placeholder="">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="task_description" class="form-control" id="task_description" placeholder="">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="number" name="task_price" class="form-control" id="task_price" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <div class="col-md-11">
